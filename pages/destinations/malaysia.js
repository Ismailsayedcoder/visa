      ...
      <Box sx={{ height: '70vh', position: 'relative' }}>
        ...
        >
          ...
          >
            ...
            >
              اكتشف سحر الطبيعة الاستوائية والثقافة الآسيوية
            </Typography>
          </motion.div>
        </Box>
      </Box>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                تجمع ماليزيا بين الطبيعة الخلابة والحضارة الحديثة، مع تنوع ثقافي فريد
              </Typography>
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                {["برجا بتروناس", "جزيرة لنكاوي", "مرتفعات جنتنج", "مدينة ملاكا"].map((highlight, idx) => (
                  <Chip
                    key={idx}
                    label={highlight}
                    icon={<LocationOnIcon />}
